...
def make_extension():
	ext = CUDAExtension(
		...
		include_dirs=[
            ...
            os.path.join(os.path.dirname(os.path.dirname(ROOT_DIR)), "third_party", "glm"),
        ],
		extra_compile_args={"nvcc": ["-I" + os.path.join(os.path.dirname(os.path.dirname(ROOT_DIR)), "third_party", "glm")]}
	)
	return ext
