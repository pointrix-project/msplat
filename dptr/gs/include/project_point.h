 ...
 * @param[in] camparam    The camera intrinsic parameters [fx, fy, cx, cy].
 ...
 * @param[in] nearest    Nearest threshold for frustum culling.
 * @param[in] extent     Extent threshold for frustum culling.
 * @return std::tuple<torch::Tensor, torch::Tensor> <br> (1) <b>uv</b> 2D
 * position of each point after projection.  <br> (2) <b>depth</b> The
 * depth value of each point. <br>
 */
/**
 ...
 * @param[in] viewmat     The world to camera view transformation matrix.
 * @param[in] projmat     The world to screen transform matrix.
 * @param[in] camparam    The intrinsic parameters of the camera [fx, fy, cx,
 * cy].
 * @param[in] W           The width of the image.
 * @param[in] H           The height of the image.
 ...
 * @return torch::Tensor <br> <b>dL_dxyz</b> Gradients of loss with respect to
 * xyz.
 */
