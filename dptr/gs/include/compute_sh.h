 ...
 * @return std::tuple<torch::Tensor, torch::Tensor> <br> (1) <b>colors</b> The
 * view-dependent RGB color. <br> (2) <b>clamped</b> The color is clamped or
 * not. <br>
 */
 ...
 * @param dL_dcolors    Gradients of the loss with respect to RGB
 * colors.
